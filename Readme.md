...
3) Go to the Libraries and open the database.php file in order to enter the identifier the password the port to connect to your database
...
3) Allez dans les Librairies et ouvrez le fichier database.php afin de saisir l'identifiant le mot de passe le port pour vous connecter à votre base de données
